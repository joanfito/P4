 ...
 function cargaJSON() {
  ...
  var ficheroJSON = JSON.stringify({
    ...
    "mapas": [{
      ...
      "8": ["X","M","X","V","C","V","V","V","O","X"],
      "9": ["X","X","X","X","X","X","X","X","X","X"]
    }, {
      "nivel": -2,
      "salto": -4,
      "0": ["X","X","X","X","X","X","X","X","X","X"],
      "1": ["X","C","V","V","X","V","V","V","V","X"],
      "2": ["X","X","X","V","X","X","X","V","V","X"],
      "3": ["X","T","V","V","V","V","X","V","G","X"],
      "4": ["X","V","V","E","V","V","G","V","V","S"],
      "5": ["X","X","X","V","V","V","V","V","C","X"],
      "6": ["X","X","B","V","M","V","X","X","X","X"],
      "7": ["X","C","X","V","V","V","V","M","V","X"],
      ...
      "2": ["B","V","V","V","V","V","V","V","C","X"],
      "3": ["X","V","X","V","V","V","V","E","V","X"],
      "4": ["X","C","X","V","M","V","V","V","V","X"],
